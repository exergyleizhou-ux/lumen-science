...
- Adapter: agent/crates/codegen/xai-grok-science/src/connectors/ensembl.rs
- Fixture: agent/crates/codegen/xai-grok-science/fixtures/connector_ensembl_*.json
- Provenance: third_party/provenance/connector-ensembl.md
