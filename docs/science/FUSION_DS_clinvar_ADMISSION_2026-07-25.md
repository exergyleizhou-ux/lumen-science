...
- Adapter: agent/crates/codegen/xai-grok-science/src/connectors/clinvar.rs
- Fixture: agent/crates/codegen/xai-grok-science/fixtures/connector_clinvar_*.json
- Provenance: third_party/provenance/connector-clinvar.md
