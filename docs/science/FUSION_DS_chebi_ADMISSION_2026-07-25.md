...
- Adapter: agent/crates/codegen/xai-grok-science/src/connectors/chebi.rs
- Fixture: agent/crates/codegen/xai-grok-science/fixtures/connector_chebi_*.json
- Provenance: third_party/provenance/connector-chebi.md
