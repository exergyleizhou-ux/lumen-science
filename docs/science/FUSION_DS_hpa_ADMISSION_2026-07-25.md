...
- Adapter: agent/crates/codegen/xai-grok-science/src/connectors/hpa.rs
- Fixture: agent/crates/codegen/xai-grok-science/fixtures/connector_hpa_*.json
- Provenance: third_party/provenance/connector-hpa.md
