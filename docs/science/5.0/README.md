...
Four Motif algorithm slices are now adapted into Rust `seqbench`: hardened
...
linear/circular topology, run inside the existing SessionActor approval and
hashed-artifact path. Exact source hashes and cross-language fixture results are in
