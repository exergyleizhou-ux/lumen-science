...
- Adapter: agent/crates/codegen/xai-grok-science/src/connectors/reactome.rs
- Fixture: agent/crates/codegen/xai-grok-science/fixtures/connector_reactome_*.json
- Provenance: third_party/provenance/connector-reactome.md
