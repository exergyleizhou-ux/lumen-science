...
| Component | Source of truth | Current (as of 2026-07-29) | Meaning |
|-----------|-----------------|----------------------------|---------|
...
5. Do **not** bump Core metadata to `0.1.251` until source parity is actually achieved.
   Known Core drift against audited Lumen main head `dc563b1e…` is machine-gated at **134** files
   (`129` diverged + `5` missing) by `scripts/check-core-drift.py` +
