...
def main() -> int:
    ...
    results = [
        ...
        ("checked-in dashboard separates four source-tree scans from component admission", good.returncode == 0 and '"sources_scanned": 4' in good.stdout and '"entries_scanned": 2326' in good.stdout),
