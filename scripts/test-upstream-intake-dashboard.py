...
def main() -> int:
    ...
    results = [
        ...
        ("checked-in dashboard separates AIPOCH tree scanning from component admission", good.returncode == 0 and '"sources_scanned": 1' in good.stdout and '"entries_scanned": 1262' in good.stdout),
