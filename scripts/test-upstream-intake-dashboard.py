...
def main() -> int:
    ...
    results = [
        ...
        ("checked-in dashboard separates three source-tree scans from component admission", good.returncode == 0 and '"sources_scanned": 3' in good.stdout and '"entries_scanned": 1773' in good.stdout),
