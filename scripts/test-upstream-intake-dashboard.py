...
def main() -> int:
    ...
    results = [
        ...
        ("checked-in dashboard separates seven external source scans from Core migration", good.returncode == 0 and '"sources_scanned": 7' in good.stdout and '"entries_scanned": 3139' in good.stdout and '"external_sources_scanned": 7' in good.stdout and '"core_sources_scanned": 0' in good.stdout),
