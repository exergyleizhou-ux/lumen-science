...
def main() -> int:
    ...
    results = [
        ...
        ("checked-in dashboard separates AIPOCH and Motif tree scanning from component admission", good.returncode == 0 and '"sources_scanned": 2' in good.stdout and '"entries_scanned": 1542' in good.stdout),
